...
=======
- обязательно поясняй, почему ты принял такое решение (особенно при начислении штрафов или баллов).
>>>>>>> e7a8055 (feat: improve AI persona, add /help, and implement /stats activity history)
...
=======
  "comment": "твой ответ в стиле джо кэмела, обязательно с пояснением причины (почему база/сила/анти/блажь)",
>>>>>>> e7a8055 (feat: improve AI persona, add /help, and implement /stats activity history)
  "is_mega": true | false,
